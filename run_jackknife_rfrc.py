...
def main():
    ...
    for stat, obs_arr, null_arr, label in [('rfold', obs_rfold, null_rfold, 'R_fold'), ('rcusp', obs_rcusp, null_rcusp, 'R_cusp')]:
        ad_full = anderson_ksamp([obs_arr.tolist(), null_arr.tolist()], variant='midrank', method='asymptotic')
        ...
        for i, entry in enumerate(obs_entries):
            ...
            ad = anderson_ksamp([reduced.tolist(), null_arr.tolist()], variant='midrank', method='asymptotic')
